  ...
  public: {
    Tables: {
      ...
      dupr_links: {
        ...
        Relationships: [
          {
            foreignKeyName: "dupr_links_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: true
      ...
      invites: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "invites_park_id_fkey"
            columns: ["park_id"]
            isOneToOne: false
      ...
      presence: {
        ...
        Relationships: [
          {
            foreignKeyName: "presence_park_id_fkey"
            columns: ["park_id"]
            isOneToOne: false
            referencedRelation: "park_live_stats"
            referencedColumns: ["park_id"]
      ...
      stack_reports: {
        ...
        Relationships: [
          {
            foreignKeyName: "stack_reports_park_id_fkey"
            columns: ["park_id"]
            isOneToOne: false
            referencedRelation: "park_live_stats"
            referencedColumns: ["park_id"]
          ...
          {
            foreignKeyName: "stack_reports_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      welcome_progress: {
        Row: {
          completed_delight: boolean
          completed_level: boolean
          completed_location: boolean
        ...
        Relationships: [
          {
            foreignKeyName: "welcome_progress_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: true
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Views: {
      ...
      park_live_stats: {
        Row: {
          ...
          median_stack_count: number | null
          park_id: string | null
          park_name: string | null
          player_count: number | null
          players_with_skill: number | null
          recent_stack_reports: number | null
